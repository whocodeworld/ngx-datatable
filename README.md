...
# Forked from https://github.com/swimlane/ngx-datatable
...
## Installation
To use ngx-datatable in your project install it via [npm](https://www.npmjs.com/package/whocodeworld/pcneo-ngx-datatable):
```
npm i pcneo-ngx-datatable --save
```
